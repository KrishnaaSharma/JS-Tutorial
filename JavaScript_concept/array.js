...
// console.log(Array.from("Krishna"));// convert string to array  ['K', 'r', 'i', 's', 'h', 'n', 'a']

// console.log(Array.from({name : "krishna"}));// it will return empty array [] because object is not iterable

// console.log(Array.from(Object.keys({name : "Krishna"})));// ['name']
// console.log(Array.from(Object.values({name : "Krishna"})));// ["Krishna"]
// console.log(Array.from(Object.entries({name : "Krishna"}))); // Array 2]
 
// console.log(JSON.stringify(Array.from(Object.entries({name: "Krishna"})))); // [["name","Krishna"]]



const arr = [10,23,34,45]; 